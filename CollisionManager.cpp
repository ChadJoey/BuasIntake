...
bool CollisionManager::DynamicRectVsRect(const rect& in, const rect& target,
...
bool CollisionManager::RayVsRect(const Tmpl8::vec2& ray_origin, const Tmpl8::vec2& ray_dir,
                                 const rect& target, Tmpl8::vec2& contact_point, Tmpl8::vec2& contact_normal, float& t_hit_near)
{
